...
class AllUsersController extends Controller
{
    ...
    private array $excludedFirebirdUserIds = [
      2,3,4,5,6,7,9,10,16,18,24,29,32,38,46,52,54,67,68,69,71,73,75,79,83,84,89,90,91,92,93,94,97,98,100
    ];
...
public function index(Request $request)
{
    ...
    private function bootFirebirdConnection(): void
    {
        config([
