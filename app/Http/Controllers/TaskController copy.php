...
class TaskController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $notificationResults = $this->notificationService->notifyParticipants($workorder);

            Log::info('STORE WORKORDER - NOTIFICATIONS RESULT', $notificationResults);
        } catch (\Exception $e) {
            // No fallar si las notificaciones fallan
            Log::error('STORE WORKORDER - NOTIFICATION ERROR', [
                'workorder_id' => $workorder->id,
                'error' => $e->getMessage(),
