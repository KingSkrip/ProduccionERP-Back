...
class UsuariosFullCollection extends ResourceCollection
{
    /**
            ...
            'data' => $this->collection->map(function ($usuario) {
                return [
                    ...
                    'sueldos' => $usuario->sueldos ? [
                        'id'              => $usuario->sueldos->id,
                        'sueldo_diario'   => $usuario->sueldos->sueldo_diario,
                        'sueldo_semanal'  => $usuario->sueldos->sueldo_semanal,
                        'sueldo_mensual'  => $usuario->sueldos->sueldo_mensual,
                        'sueldo_anual'    => $usuario->sueldos->sueldo_anual,
                    ] : null,

                    'sueldos_historial' => $usuario->sueldos && $usuario->sueldos->historial ?
                        $usuario->sueldos->historial->map(function ($historial) {
                            return [
                                'id'             => $historial->id,
