...
return new class extends Migration
{
    ...
    {
        Schema::create('checador_entradas', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('minutos_retardo')->default(0);
            $table->boolean('es_retardo')->default(false);
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('checador_entradas');
    }
};
